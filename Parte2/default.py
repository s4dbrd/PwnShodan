...
def inicio():
    r=session.get(webscan_base+'host/search?&query=all',params=payload)
    response=r.json()
    ips=[]
    ...
    return render_template('inicio.html', randomip=randomip, randomcamip=randomcamip1, randomcamip2=randomcamip2)
